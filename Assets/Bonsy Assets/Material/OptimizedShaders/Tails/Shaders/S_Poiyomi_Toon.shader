Shader "Hidden/.poiyomi/• Poiyomi Toon •/Tails-Tails"
{
    Properties
    {
...
#define _ALPHABASECUTOUT_ON
#define _ENABLELIGHTFALLOFF_ON
#define _FRESNELONLIGHT_ON
#define _SHADOWMASKGLOSSTEXTURE_ON
#define _SHOWSHADOWTONLIGHT_ON
#define _SMOOTHNESS_TEXTURE_ALBEDO_CHANNEL_A
#define _USEGILIGHTING_ON
...
#define PROP_LIGHTINGSTANDARDSMOOTHNESS 0.42
